...
import pandas as pd
import pytest
from src.labeling.volatility import daily_vol, get_volatility_targets, vol_regime
...
def test_vol_regime(sample_close):
    regime = vol_regime(sample_close, span_fast=5, span_slow=20)
