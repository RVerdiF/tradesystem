...
otimização não seja fruto do acaso, considerando o número de tentativas e
a variância dos resultados.
...
def deflated_sharpe_ratio(
    ...
    ----------
    observed_sr : float
        Sharpe Ratio anualizado da melhor configuração encontrada.
    sr_values : list ou np.ndarray
        Lista de todos os Sharpe Ratios obtidos durante o processo de otimização.
    n_trials : int
        Número total de trials (testes) independentes realizados.
    n_days : int
        Número de observações (dias ou barras) utilizadas no backtest.
